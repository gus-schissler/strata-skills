...
class FindSkillPackagingTests(unittest.TestCase):
    ...
    def test_workflow_enforces_verified_read_only_retrieval(self):
        ...
        required_contract = (
            ...
            "strata_get_document",
            "The document response contains claim snippets, not full claim bodies",
            "Then fetch every relevant node in full before citing it",
            "confirming that `truncated` is `false`",
            "strata_list_edges",
            "strata_traverse",
